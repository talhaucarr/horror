...
using UnityEditor;
    ...
    public class GroupDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!property.isExpanded || !attr.OnlyShowPrefixIfNotExpanded)
            {
                displayName = attr.PrefixText + displayName;
            }

            if (GUI.Button(EditorGUI.IndentedRect(rect), displayName, EditorGUICustom.StandardButtonStyle))
