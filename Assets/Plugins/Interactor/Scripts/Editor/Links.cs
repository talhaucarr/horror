...
namespace razz
{
    public class Links : Editor
    {
        ...
        public static string messageDesc = "Start a private conversation with me for anything, when you have great suggestions or when you need help.";
        ...
        public static void InteractorScript()
        {
            ...
            AssetDatabase.OpenAsset(ms, 853);
        }

        public static string interactorEditorScriptName = "Expose Properties";
        public static string interactorEditorScriptDesc = "If you like to add more properties here, this goes into editor script code.";
        public static void InteractorEditorScript()
        {
            ...
            AssetDatabase.OpenAsset(ms, 780);
        }
